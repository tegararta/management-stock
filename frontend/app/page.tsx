...
export default function Home() {
  ...
  const loadProducts = async () => {
    try {
      const data = await apiClient.getProduks();
      // Pastikan data adalah array
      // Tambah filter setelah get data dari API
const filteredProducts = data.filter(
  (product) => product.status.toLowerCase() === 'bisa dijual'
);
            ...
            <div className="px-6 py-4 border-b bg-gray-50">
              <div className="flex justify-between items-center">
                <div>
                  ...
                  <p className="text-sm text-gray-600 mt-1">{products.length} produk ditemukan</p>
                </div>
                ...
                <table className="min-w-full divide-y divide-gray-200">
                  ...
                  <tbody className="bg-white divide-y divide-gray-200">
                    {products.map((product, index) => (
                      <tr key={product.id_produk} className="hover:bg-gray-50 transition">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          ...
                          <div className="text-xs text-gray-500">Harga satuan</div>
                        </td>
                        <td className="px-6 py-4 whitespace-nowrap">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <span
                            className={`inline-flex items-center px-3 py-1 rounded-full text-xs font-medium ${
                              product.status.toLowerCase().includes('jual')
